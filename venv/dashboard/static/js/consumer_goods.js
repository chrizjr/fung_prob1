queue()
    .defer(d3.csv, "../static/consumer_goods.csv")
    .await(makeGraphs);
...
function makeGraphs(error, region_data) {
	...
	.colors(d3.scale.ordinal().range(['#b3d9ff', '#e6ac00', '#85e085', '#ff751a', '#adebeb']))
	;
	...
	colorsChart
		...
		.colors(d3.scale.ordinal().range(['#404040', '#3399ff', '#b38600', '#80ff80', '#ff8000', '#70dbdb', '#e699ff', '#ff4d4d', '#8c8c8c', '#e6e600']))
	;
